...
# -----data related-----
data_root = '/data/ephemeral/home/dataset/'  # Root path of data
# path of train annotation file
train_ann_file = 'train.json'
train_data_prefix = './'  # Prefix of train image path
# path of val annotation file
val_ann_file = 'train.json'
...
# wandb.init(
#     project="swin_l, yolox",
#     name="experiment_001",
#     config={"epochs": 50, "batch_size": 4},
#     notes="Testing different architectures",
#     tags=["YOLOv5", "SwinTransformer"]
# )
metainfo = {
