...
backend_args = None
checkpoint_file = './configs/dino/convnext-large_in21k-pre-3rdparty_in1k-384px_20221219-6d38dd66.pth'
custom_imports = dict(
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            checkpoint=
            './configs/dino/convnext-large_in21k-pre-3rdparty_in1k-384px_20221219-6d38dd66.pth',
            prefix='backbone.',
            type='Pretrained'),
